...
int main()
{
    constexpr int DIE1_SIDES = 6;   // Number of sides for die #1.
    constexpr int DIE2_SIDES = 12;  // Number of sides for die #2.
    constexpr int MAX_ROLLS = 5;    // Number of times rolled.

    // Two instances of the Die Class.
    Die die1(DIE1_SIDES);
    Die die2(DIE2_SIDES);
